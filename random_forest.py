"""
Supervised anomaly classifier using Random Forest, optimized for intrusion detection.
...
def evaluate_on_external_test(test_df, feature_columns: list, train_df: pd.DataFrame):
    print("\n=== Retraining final model on 100% of Training Data for External Evaluation ===")
    
    full_model = RandomForestClassifier(n_estimators=200, max_depth=20, random_state=RANDOM_STATE, n_jobs=-1)
